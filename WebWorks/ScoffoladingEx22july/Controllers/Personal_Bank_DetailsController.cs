...
{
    public class Personal_Bank_DetailsController : Controller
    {
        private Personal_DetailsEntities db = new Personal_DetailsEntities();

        // GET: Personal_Bank_Details
        public ActionResult Index()
        {
            return View(db.Personal_Bank_Details.ToList());
        }

        // GET: Personal_Bank_Details/Details/5
        ...
        // GET: Personal_Bank_Details/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: Personal_Bank_Details/Create
        ...
        // GET: Personal_Bank_Details/Edit/5
        ...
        // POST: Personal_Bank_Details/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: Personal_Bank_Details/Delete/5
        ...
        // POST: Personal_Bank_Details/Delete/5
